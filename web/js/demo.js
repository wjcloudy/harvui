...
(function () {
  ...
  const workloads = [
    ...
    { name: "homestead", ns: "lab", kind: "Deployment", group: "Homestead", self: true, desired: 1, ready: 1, uptime: 86400,
      ...
      images: ["ghcr.io/wjcloudy/homestead:2.8.169"], ports: [{ port: 8088, ip: "192.168.1.242" }],
      pod_count: 1, container_count: 1, pods: [pod("homestead", "harvester-node1", "ghcr.io/wjcloudy/homestead:2.8.169")] },
  ...
  const responses = {
    ...
    "/api/settings": { thresholds: { cpu: { warning: 70, critical: 88 }, memory: { warning: 70, critical: 88 }, disk: { warning: 75, critical: 90 }, temperature: { warning: 70, critical: 85 } }, smart: { temperature: { warning: 55, critical: 65 }, reallocated_warning: 1, pending_critical: 1, uncorrectable_critical: 1, notify_failures: true }, updates: { policy: "approval_required", notify_available: true, notify_failures: true }, site_name: "Loft rack",
      info: { version: "2.8.169", namespace: "lab", storage_class: "longhorn-r2", vip: "192.168.1.242",
    ...
    "/api/move/clusters/check": (url, init) => {
      ...
      if (name === "garage") return { name, version: "2.8.169", protocol: 1, local_version: "2.8.169",
        local_protocol: 1, state: "differs", compatible: true,
        message: "garage runs 2.8.169 and this one 2.8.169. Moves work between them; garage is the newer of the two." };
      return name === "attic"
        ? { name, version: "2.8.55", protocol: 0, local_version: "2.8.169", local_protocol: 1,
            state: "behind", compatible: false,
            message: "attic runs Homestead 2.8.55, too old to move workloads with this one (2.8.169). Update attic first." }
        : { name, version: "2.8.169", protocol: 1, local_version: "2.8.169", local_protocol: 1,
            state: "same", compatible: true, message: "Both run Homestead 2.8.169." };
    },
    ...
    "/api/move/remote": { cluster: "shed", url: "http://192.168.1.250:8088",
      namespace: "lab", version: "2.8.169", protocol: 1, movable: 2, workloads: [
...
`, network_data: "", source: "secret" },
    ...
    "/api/self/health": () => {
      ...
      return { version: "2.8.169", leader: true, identity: "homestead-6d9f-abcde",
        api: { ok: true, ms: 38 },
    ...
    "/api/image-updates": { checked_at: new Date().toISOString(), updates: 3, errors: 1,
      ...
      { ns: "lab", name: "homestead", available: true, can_rollback: true,
        images: [{ container: "homestead", deployed: "ghcr.io/wjcloudy/homestead:2.8.29", candidate: "ghcr.io/wjcloudy/homestead:2.8.169", candidate_tag: "2.8.169", remote_digest: "sha256:ghi", available: true }] },
