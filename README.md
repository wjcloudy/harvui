...
```bash
kubectl apply -f https://raw.githubusercontent.com/wjcloudy/homestead/v2.8.150/deploy/rbac.yaml
```
...
```bash
TAG=2.8.150 HOST=rancher@your-harvester-node ./scripts/deploy.sh
```
...
For a release such as `v2.8.150`, the workflow publishes:

```text
ghcr.io/wjcloudy/homestead:2.8.150
