...
For a release such as `v2.8.61`, the workflow publishes:

```text
ghcr.io/wjcloudy/homestead:2.8.61
...
```bash
TAG=2.8.61 HOST=rancher@your-harvester-node ./scripts/deploy.sh
```
