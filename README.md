...
For a release such as `v2.8.66`, the workflow publishes:

```text
ghcr.io/wjcloudy/homestead:2.8.66
...
```bash
TAG=2.8.66 HOST=rancher@your-harvester-node ./scripts/deploy.sh
```
