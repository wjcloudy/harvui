...
For a release such as `v2.8.53`, the workflow publishes:

```text
ghcr.io/wjcloudy/homestead:2.8.53
...
```bash
TAG=2.8.53 HOST=rancher@your-harvester-node ./scripts/deploy.sh
```
